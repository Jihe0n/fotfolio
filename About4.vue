...
<section class="section section--contact" id="contact">
    <div class="section__inner">
        <div class="block">
            <a class="pre" href="#contact">Thank you for watching </a>
            <h2>please email:<br>
                <span><a href="mailto:hello@volkerotto.net">siwmua99@google.com</a></span></h2>
...
<section class="section section--clients" id="clients" style="
    padding-top: 0px;
    padding-bottom: 0px;
">
