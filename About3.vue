...
<div class="flex flex-col min-h-screen">
  <header class="flex items-center py-3 px-3 z-10 shadow">
    ...
    <div class="flex-1 justify-center hidden sm:flex">
      <input type="text" placeholder="Search" class="border border-grey px-3 py-2 w-1/2 max-w-md outline-none rounded-l"/>
      <button class="flex justify-center items-center bg-grey-lighter px-6 border border-grey border-l-0 rounded-r focus:outline-none hover:bg-grey-light">
  ...
  <main class="flex-1 bg-grey-lightest z-0 py-5 px-5">
    <div class="flex flex-wrap max-w-5xl mx-auto">
      ...
      <div class="w-full md:flex-1">
        <!-- player -->          
        <div class="video-center relative mb-3" :style="{paddingTop : '55%', backgroundImage: bg_main}">      
          <iframe  class="w-full h-full absolute pin-x pin-t" 
                  src="" 
                  frameborder="0" 
        ...
        <div class="flex flex-wrap items-end">
          <!-- title -->
          <div class="pb-2">
            <h1 class="text-xl my-2">日本語のニュースを聞く2 (일본어 뉴스듣기 2)</h1>
            <!-- <span class="text-grey-darken">13 000 views</span> -->
          </div>
          <!-- buttons actions -->
          <div class="ml-auto">
            <!-- likes -->
            <div class="flex relative pb-2">
              ...
              <div class="flex items-center">
                <svg @click="plus" class="w-5 opacity-75" viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"><g><path d="M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-1.91l-.01-.01L23 10z"  class="style-scope yt-icon"></path></g></svg>
                <span class="text-xs text-grey-darken ml-1">{{ like }}</span>
              </div>
              <!-- hate -->
              <div class="flex items-center ml-5">
                <svg @click="minus" class="w-5 opacity-75"  viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet"><g><path d="M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v1.91l.01.01L1 14c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z"  class="style-scope yt-icon"></path></g></svg>
                <span class="text-xs text-grey-darken ml-1">{{ dislike }}</span>
              </div>
      ...
      <aside class="w-full md:max-w-xs xl:max-w-full xl:w-1/4 md:pl-5 mt-5 md:mt-0">
        ...
        <div class="w-full">
          ...
          <!-- video1 -->
          <div @click="movieClick1()" class="flex flex-wrap w-full">
            <div class="w-1/2 video1" :style="{paddingTop: '30%', backgroundImage: bg_1 }"></div>
            <div class="w-1/2 pl-2">
              <h3 class="text-base mb-2">Video title</h3>
          ...
          <div @click="movieClick2()" class="flex flex-wrap w-full mb-3">
            <div class="w-1/2 video2" style="padding-top: 30%"></div>
            <div class="w-1/2 pl-2">
              <h3 class="text-base mb-2">Video title</h3>
              <p class="text-sm text-grey-darken mb-1">Chanel</p>
              <p class="text-sm text-grey-darken mb-1">13K views</p>
          ...
          <div @click="movieClick3()" class="flex flex-wrap w-full mb-3">
            <div class="w-1/2 video3" style="padding-top: 30%"></div>
            <div class="w-1/2 pl-2">
              <h3 class="text-base mb-2">Video title</h3>
              <p class="text-sm text-grey-darken mb-1">Chanel</p>
              <p class="text-sm text-grey-darken mb-1">13K views</p>
          ...
          <div @click="movieClick4()" class="flex flex-wrap w-full mb-3">
            <div class="w-1/2 video4" style="padding-top: 30%"></div>
            <div class="w-1/2 pl-2">
              <h3 class="text-base mb-2">Video title</h3>
              <p class="text-sm text-grey-darken mb-1">Chanel</p>
              <p class="text-sm text-grey-darken mb-1">13K views</p>
...
export default {
  ...
  methods: {
            ...
            movieClick1(){
              ...
              this.bg_main = 'url(/img/11.64d2b663.png)';
             
            },
            movieClick2(){
              this.bg_main = 'url(/img/22.0d03fdbf.png)';
            }, 
            movieClick3(){
              this.bg_main = 'url(/img/33.f839624a.png)';
            }, 
            movieClick4(){
              this.bg_main = 'url(/img/44.6bce0d37.png)';
            },
